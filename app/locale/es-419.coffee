module.exports = nativeDescription: "Español (América Latina)", englishDescription: "Spanish (Latin America)", translation:
  ...
  new_home:
    ...
    great_game: "Un gran juego es más que sólo medallas y logros - se trata sobre una travesía del jugador, acertijos bien diseñados, y la habilidad de abordar desafios con voluntad y confianza."
    ...
    check_out_wiki: "Conoce nuestra nueva Wiki educadora"
...
#    nil: "nil"
  ...
  play_level:
    ...
    victory_no_progress_for_teachers: "Los maestros no pueden guardar su progreso, pero pueden añadir a su aula una cuenta de estudiante para sí mismos."
    guide_title: "Guía"
    ...
    tip_extrapolation: "Sólo hay dos tipos de personas: Esas que pueden extrapolar desde información incompleta..."
    ...
    tip_solve_then_write: "Primero, resuelve el problema. Despues, escribe el código. - John Johnson"
...
#    tip_programming_not_about_computers: "La ciencia cpomputacional is no more about computers than astronomy is about telescopes. - Edsger Dijkstra"
  ...
  subscribe:
    ...
    parents_blurb1: "Con CodeCombat, su hijo aprenderá a escribiendo código real. Empezará aprendiendo comandos simples y avanzando a temas más complejos."
    parents_blurb1a: "La Programación es una habilidad escencial que su hijo sin duda usará en la adultez. Para el 2020, habilidades básicas en software serán requeridas por el 77% de los trabajos, y los ingenieros de software están en alta demanda alrededor del mundo. ¿Sabía que Ciencias de la Computación es la carrera mejor pagada?"
...
#    no_purchaser_role: "No role in purchase decisions"
  ...
  keyboard_shortcuts:
    ...
    scrub_playback: "Retroceder y avanzar en el tiempo."
    single_scrub_playback: "Retroceder y avanzar en el tiempo de a un cuadro."
  ...
  community:
    ...
    level_editor_suffix: "para crear y editar niveles. Los han creado niveles para sus clases, amigos, hackatones, estudiantes, familiares. Si crear un nuevo juego luce intimidante ¡puedes comenzar utilizando uno nuestro como base!"
  ...
  courses:
    ...
    coming_soon2: "Estamos trabajando duro para hacer más cursos para ti!"
    ...
    ready_for_more_header: "¿Listo para más? ¡Juega el modo campaña!"
    ready_for_more_1: "¡Usa las gemas para desbloquear nuevos objetos!"
    ready_for_more_2: "Juega a través de nuevos mundos y desafios"
    ...
    not_you: "¿No eres tú?"
    welcome_back: "Hola aventurero, ¡Bienvenido otra vez!"
    continue_playing: "Seguir jugando"
    more_options: "Más opciones:"
    option1_header: "Opción 1: Invitar estudiantes vía email"
    option1_body: "Se enviará automaticamente una invitación a los estudiantes para unirse a esta clase. Tendrán que crear una cuenta con un nombre de usuario y una contraseña."
    ...
    optional_ask: "opcional - ¡Pide a tu maestro que te de uno!"
    optional_school: "opcional - ¿A qué escuela vas?"
    start_playing: "Comienza a Jugar"
    skip_this: "Saltar esto, ¡Crearé una cuenta más tarde!"
    welcome: "Bienvenido"
    ...
    getting_started_2: "Una vez creada una clase, haz click en el botón azul 'Añadir Estudiantes'"
...
#    total_unenrolled: "Total unenrolled"
  ...
  contribute:
    ...
    intro_blurb: "¡CodeCombat es 100% Código Abierto! Cientos de jugadores dedicados nos han ayudado a construir el juego. Únete y escribe el siguiente capítulo de la misión de CodeCombat de ¡enseñar al mundo a programar!"
  ...
  account_invoices:
    ...
    not_logged_in: "Ingresa o crea una cuenta para acceder a las facturas."
    pay: "Pagar Factura"
    purchasing: "Comprando..."
  ...
  loading_error:
    ...
    error: "ERROR"
    general_desc: "Ocurrió un error, probablemente es tu culpa. Espera un poco y luego carga de nuevo la página, o ¡visita uno de los siguientes enlaces para regresar a programar!"
  ...
  multiplayer:
    ...
    multiplayer_link_description: "Comparte este enlace a cualquiera para que se te una."
    multiplayer_hint_label: "Consejo:"
    multiplayer_hint: " Haz clic en el enlace para seleccionar todo, luego presiona ⌘-C o Ctrl-C para copiar el enlace."
  ...
  legal:
    ...
    opensource_intro: "CodeCombat es completamente de código abierto."
    opensource_description_prefix: "Echa un vistazo a "
    github_url: "nuestro GitHub"
    opensource_description_center: "y ¡ayúdanos si quieres! CodeCombat esta construido por docenas de proyectos de código abierto, y los amamos. Mira "
    ...
    email_settings_url: "tus opciones de correo"
    email_description_suffix: "o mediante enlaces en los correos que mandemos; puedes cambiar tus preferencias y cancelar fácilmente tu suscripción en cualquier momento."
    cost_title: "Costo"
    cost_description: "CodeCombat es gratuito para todos sus niveles principales, con una suscripción de ${{price}} USD/mes con acceso a niveles adicionales y un bonus de {{gems}} gemas cada mes. Puedes cancelar con un click; ofrecemos una garantía del 100%."
    ...
    code_description_suffix: "Esto incluye todo el código en Sistemas y Componentes que ha sido puesto a disposición por CodeCombat con el propósito de crear niveles."
    art_title: "Arte/Música - Creative Commons "
    art_description_prefix: "Todo el Contenido Común está disponible bajo la"
    cc_license_url: "Licencia Internacional de Atribución Creative Commons (CC) 4.0"
    art_description_suffix: "Contenido Común es cualquiera hecho por CodeCombat y disponile con el propósito de crear niveles. Esto incluye:"
    art_music: "Música"
    art_sound: "Sonido"
